...
public class Pass extends JFrame {
	...
	public Pass() {
		...
		JLabel lblNewLabel_4_1 = new JLabel("Pass Certificate");
		lblNewLabel_4_1.setBounds(372, 63, 182, 37);
		...
		JLabel lblNewLabel_6_2 = new JLabel("has passed in the Year");
		...
		JLabel lblNewLabel_6_2_1_1 = new JLabel("His / Her Date of Birth according to our G.R is");
		lblNewLabel_6_2_1_1.setFont(new Font("Times New Roman", Font.PLAIN, 25));
		lblNewLabel_6_2_1_1.setBounds(171, 246, 477, 34);
		...
		separator_1_1_2.setBounds(271, 229, 188, 2);
		panel_4.add(separator_1_1_2);
		
		JSeparator separator_1_1_2_1 = new JSeparator();
		separator_1_1_2_1.setBounds(657, 271, 188, 2);
		panel_4.add(separator_1_1_2_1);
		
		year = new JLabel("");
		year.setHorizontalAlignment(SwingConstants.CENTER);
		year.setFont(new Font("Pristina", Font.BOLD, 25));
		year.setBounds(292, 203, 147, 35);
		panel_4.add(year);
