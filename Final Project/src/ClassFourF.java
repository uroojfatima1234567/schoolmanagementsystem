...
public class ClassFourF extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ClassFourF frame = new ClassFourF();
	...
	public ClassFourF() {
		...
		btnNewButton.setBounds(169, 264, 65, 26);
