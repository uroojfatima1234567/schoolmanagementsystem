...
public class UnpaidStudents extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					UnpaidStudents frame = new UnpaidStudents();
	...
	public UnpaidStudents() {
		...
		Statement	s=c.createStatement();	//Step 3
			String query="SELECT * from payment where Status='Unpaid'";
		...
		JLabel lblNewLabel = new JLabel("Unpaid Fess Students");
