...
public class ClassOneF extends JFrame {
	...
	public ClassOneF() {
		...
		comboBox.setBounds(119, 223, 115, 26);
		...
		scrollPane.setBounds(10, 61, 1003, 481);
...
//				Statement s;
				...
				try 
				{
					...
					String query="SELECT * from studentdata where class in('One')";
