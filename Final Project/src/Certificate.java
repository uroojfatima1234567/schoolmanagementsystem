...
public class Certificate extends JFrame {
	...
	public Certificate() {
		...
		JButton btnNewButton_3 = new JButton("Character CR");
		btnNewButton_3.setBackground(UIManager.getColor("Button.disabledForeground"));
		btnNewButton_3.setFont(new Font("Tahoma", Font.BOLD, 14));
		btnNewButton_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent et) {
				
				if(stName.getText().equals("") || ftName.getText().equals("") || srName.getText().equals(""))
				{
		...
		btnNewButton_3.setBounds(288, 465, 142, 35);
		panel_2.add(btnNewButton_3);
		
		JLabel lblNewLabel_4_1 = new JLabel("Certificates");
		...
		JLabel lblNewLabel_4_1_1_2 = new JLabel("Surname");
		lblNewLabel_4_1_1_2.setFont(new Font("Times New Roman", Font.BOLD, 25));
		lblNewLabel_4_1_1_2.setBounds(288, 263, 161, 45);
		panel_2.add(lblNewLabel_4_1_1_2);
		
		JButton btnNewButton_3_1 = new JButton("Pass CR");
		btnNewButton_3_1.setBackground(UIManager.getColor("Button.disabledForeground"));
		btnNewButton_3_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				
				if(stName.getText().equals("") || ftName.getText().equals("") || srName.getText().equals("") || dob.getText().equals("")
						|| yea.getText().equals(""))
				...
				else
				{
					...
					send1.sname.setText(stName.getText());
					send1.fname.setText(ftName.getText());
					send1.surname.setText(srName.getText());
					send1.DOB.setText(dob.getText());
					send1.year.setText(yea.getText());
		...
		btnNewButton_3_1.setBounds(566, 465, 142, 35);
		...
		srName.setFont(new Font("Tahoma", Font.BOLD, 15));
		srName.setColumns(10);
		srName.setBounds(475, 263, 233, 36);
		panel_2.add(srName);
		...
		JLabel lblNewLabel_4_1_1_2_1 = new JLabel("Date of Birth");
		lblNewLabel_4_1_1_2_1.setFont(new Font("Times New Roman", Font.BOLD, 25));
		lblNewLabel_4_1_1_2_1.setBounds(288, 328, 161, 45);
		panel_2.add(lblNewLabel_4_1_1_2_1);
		
		dob = new JTextField();
		dob.setFont(new Font("Tahoma", Font.BOLD, 15));
		dob.setColumns(10);
		dob.setBounds(475, 328, 233, 36);
		panel_2.add(dob);
		
		JLabel lblNewLabel_4_1_1_2_2 = new JLabel("Year");
		lblNewLabel_4_1_1_2_2.setFont(new Font("Times New Roman", Font.BOLD, 25));
		lblNewLabel_4_1_1_2_2.setBounds(288, 390, 161, 45);
		panel_2.add(lblNewLabel_4_1_1_2_2);
		
		yea = new JTextField();
		yea.setFont(new Font("Tahoma", Font.BOLD, 15));
		yea.setColumns(10);
		yea.setBounds(475, 390, 233, 36);
		panel_2.add(yea);
		
		JLabel lblNewLabel_5 = new JLabel("Note:");
		lblNewLabel_5.setFont(new Font("Tahoma", Font.BOLD, 14));
		lblNewLabel_5.setForeground(new Color(255, 0, 0));
		lblNewLabel_5.setBounds(839, 348, 47, 25);
		panel_2.add(lblNewLabel_5);
		
		JLabel lblNewLabel_6 = new JLabel("Date of Birth and Year is mandatory ");
		lblNewLabel_6.setFont(new Font("Trebuchet MS", Font.ITALIC, 15));
		lblNewLabel_6.setBounds(745, 374, 268, 35);
		panel_2.add(lblNewLabel_6);
		
		JLabel lblNewLabel_6_1 = new JLabel("for Pass Certificate only.");
		lblNewLabel_6_1.setFont(new Font("Trebuchet MS", Font.ITALIC, 15));
		lblNewLabel_6_1.setBounds(745, 397, 268, 35);
