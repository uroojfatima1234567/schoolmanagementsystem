...
public class ClassThreeF extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ClassThreeF frame = new ClassThreeF();
	...
	public ClassThreeF() {
		...
		btnNewButton.setBounds(169, 274, 65, 26);
		...
		scrollPane.setBounds(10, 59, 1003, 483);
...
//				Statement s;
				...
				try 
				{
					...
					String query="SELECT * from studentdata where class in('Three')";
